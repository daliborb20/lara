...
nmap ,t :tag 
nnoremap ,n :call PhpInsertUse()
xnoremap ,n :call PhpInsertUse()
onoremap ,n :call PhpInsertUse()
...
nmap ,eu gg=G 
nmap ,  :nohlsearch
nmap ,es :tabedit ~/.vim/UltiSnips/php.snippets
...
set linespace=15
set pyxversion=2
set runtimepath=~/vimfiles,~\\.vim\\plugged\\Vundle.vim,~\\.vim\\plugged\\vim-fugitive,~\\.vim\\plugged\\vim-vinegar,~\\.vim\\plugged\\ctrlp.vim,~\\.vim\\plugged\\nerdtree,~\\.vim\\plugged\\ag.vim,~\\.vim\\plugged\\greplace.vim,~\\.vim\\plugged\\vim-snipmate,~\\.vim\\plugged\\vim-surround,~\\.vim\\plugged\\php.vim,~\\.vim\\plugged\\vim-php-namespace,~\\.vim\\plugged\\supertab,~\\.vim\\plugged\\vim-addon-mw-utils,~\\.vim\\plugged\\tlib_vim,~\\.vim\\plugged\\vim-php-cs-fixer,~\\.vim\\plugged\\vmustache,~\\.vim\\plugged\\pdv,~\\.vim\\plugged\\ultisnips,~\\.vim\\plugged\\emmet-vim,~\\.vim\\plugged\\vim-airline,~\\.vim\\plugged\\auto-pairs,~\\.vim\\plugged\\nerdcommenter,~\\.vim\\plugged\\palenight.vim,~\\.vim\\plugged\\vim-css-color,~\\.vim\\plugged\\indentLine,C:\\Program\ Files\ (x86)\\Vim/vimfiles,C:\\Program\ Files\ (x86)\\Vim\\vim81,C:\\Program\ Files\ (x86)\\Vim/vimfiles/after,~/vimfiles/after,~\\.vim\\plugged\\vim-snipmate\\after,~\\.vim\\plugged\\ultisnips\\after,~\\.vim\\plugged\\vim-css-color\\after,~\\.vim\\plugged\\indentLine\\after,~/.vim/autload/plug.vim
set shiftwidth=4
set showmatch
set smartindent
set softtabstop=4
...
set shortmess=aoO
badd +10 pdo.php
badd +5 \Users\boogyman\.vimrc
badd +0 konekcija\connect.php
badd +0 konekcija\query.php
badd +30 \Users\boogyman\.vim\plugins.vim
argglobal
silent! argdel *
$argadd .\
edit pdo.php
...
exe 'vert 1resize ' . ((&columns * 59 + 88) / 177)
exe 'vert 2resize ' . ((&columns * 58 + 88) / 177)
exe 'vert 3resize ' . ((&columns * 58 + 88) / 177)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
18
normal! 0
lcd C:\xampp\htdocs\lara
wincmd w
argglobal
if bufexists('C:\xampp\htdocs\lara\konekcija\query.php') | buffer C:\xampp\htdocs\lara\konekcija\query.php | else | edit C:\xampp\htdocs\lara\konekcija\query.php | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> ¢ =AutoPairsMoveCharacter('"')
...
wincmd w
argglobal
if bufexists('C:\xampp\htdocs\lara\konekcija\connect.php') | buffer C:\xampp\htdocs\lara\konekcija\connect.php | else | edit C:\xampp\htdocs\lara\konekcija\connect.php | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> ¢ =AutoPairsMoveCharacter('"')
